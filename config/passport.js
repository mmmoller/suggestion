                    ...
                    if (user) {
                        ...
                        Infosys.findOne({}, function(err, infosys){
                            ...
                            if (infosys){
                                ...
                                newUser.followers = [];
                                newUser.followers_coefficient = [];
                                newUser.index = infosys.users.length;
                                infosys.users.push(newUser.username)
            ...
            // if the user is logged in but has no local account...
                ...
                User.findOne({ 'local.email' :  email }, function(err, user) {
                    ...
                    if (user) {
                        ...
                        // Using 'message instead of signupMessage because it's used by /connect/local'
                    } else {
                        var user = req.user;
